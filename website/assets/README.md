...
[![deno.land](https://img.shields.io/endpoint?url=https%3A%2F%2Fdeno-visualizer.danopia.net%2Fshields%2Flatest-version%2Fx%2Fdero@1.2.3%2Fmod.ts)](https://deno.land/x/dero)
...
### deno.land
```ts
import {...} from "https://deno.land/x/dero@1.2.3/mod.ts";
```
### nest.land
```ts
...
## HttpRequest
```ts
import { HttpRequest } from "https://deno.land/x/dero@1.2.3/mod.ts";
```
### request.query
...
## HttpResponse
```ts
import { HttpResponse } from "https://deno.land/x/dero@1.2.3/mod.ts";
```
### response.header
...
## Classic
```ts
import { dero } from "https://deno.land/x/dero@1.2.3/mod.ts";
...
```ts
...
import { Dero, Router } from "https://deno.land/x/dero@1.2.3/mod.ts";
...
```ts
...
import { BadRequestError } from "https://deno.land/x/dero@1.2.3/error.ts";

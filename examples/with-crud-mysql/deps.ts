...
// dero
export { Get, Wares, Post, Put, Delete, Controller, addControllers, Dero } from "https://deno.land/x/dero@0.1.1/mod.ts";
export type { Request, Response, NextFunction } from "https://deno.land/x/dero@0.1.1/mod.ts";

...
// dero
export { Get, Wares, Post, Put, Delete, Controller, addControllers, Dero } from "https://deno.land/x/dero@0.1.6/mod.ts";
export type { HttpRequest, HttpResponse, NextFunction } from "https://deno.land/x/dero@0.1.6/mod.ts";

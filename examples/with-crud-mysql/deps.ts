...
// dero
export { Get, Wares, Post, Put, Delete, Controller, Dero, Status } from "https://deno.land/x/dero@0.2.1/mod.ts";
export type { HttpRequest, HttpResponse, NextFunction } from "https://deno.land/x/dero@0.2.1/mod.ts";
